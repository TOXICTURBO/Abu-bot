...
Maalutty.addCommand({pattern: 'abu', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Abuserine tholpikkaan ningalkavilla. Jeevitathil Abusereye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Abuser says i love you 😘";
r_text[3] = "Abuserrinte yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Abuser - Bot -  Abuser\ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Abuser ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = "Abuser is secret of my energy😎";
...
r_text[18] = "enikk njan und Abuser uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Abuser pazhaya Abuser thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik  Abuserkk";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee  Abuser😆";
