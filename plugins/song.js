...
r_text[1] = "Aʙᴜ botne tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Aʙᴜ bot says i love you 😘";
r_text[3] = "Aʙᴜ bot inte yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Aʙᴜ bot - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Aʙᴜ sed,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Aʙᴜ bot";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Aʙᴜ bot pazhaya pinky thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Aʙᴜ bot";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Aʙᴜ bot";
